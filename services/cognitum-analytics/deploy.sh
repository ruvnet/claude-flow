...
echo ""
echo "The client already defaults to https://cognitum-analytics-<hash>-uc.a.run.app/v1/events."
echo "If Cloud Run assigned a different hostname hash, update the DEFAULT_ENDPOINT"
echo "constant in v3/@claude-flow/cli/src/funnel/event-transport.ts."
