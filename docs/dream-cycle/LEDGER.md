...
| 2026-08-24 | swarm | QueenCoordinator.weightedConsensus() trust weights computed but structurally unreachable in raft/byzantine/gossip vote tally — now threaded through with [0,1] safety clamp | #3085 | #3086 | yes | ACCEPT | gossip weighted-flip: flat 0.50 (reject) → weighted ≈0.905 (approve); 226/226 tests, 0 regressions | 08d44c58... | 08-16..08-19 all MERGED (2026-08-21); 08-14/#3027 and 08-15/#3034 REJECT-evidence PRs correctly still unmerged. Recovery note: this row was missing from the ledger despite the branch/issue/PR existing — appended live 2026-08-25 per STEP 1's anti-inference verification (git ls-remote + direct issue/PR reads), not the earlier 08-14..08-18 append-failure pattern (root cause still undiagnosed) |
| 2026-08-25 | performance | HNSW product-quantization: productQuantizeDistance() correctly implemented but zero callers — generic distance ran on raw PQ centroid indices, numerically meaningless; now dispatched, with a disclosed residual isValidPQEncoding() plausibility-heuristic caveat | #3093 | #3094 | yes | ACCEPT | recall@10 0.097 (pre-fix) → 0.270 (post-fix) on deterministic synthetic corpus, ~2.8x; 461/462 tests, 0 regressions | 300da158... | 08-24/#3086 still OPEN draft (unmerged); 08-16..08-19 all MERGED; 08-14/#3027, 08-15/#3034 REJECT-evidence PRs correctly still unmerged; 2026-08-20..23 gap re-confirmed, still undiagnosed |
