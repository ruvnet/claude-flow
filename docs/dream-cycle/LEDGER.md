...
**Recovery note (2026-09-02):** rows for 2026-08-24 through 2026-09-01 (9 nights) were never appended live despite all 9 nights running to completion (branch + issue + evaluated draft PR exist for each — verified via `git ls-remote` and the GitHub PR listing before concluding this, per STEP 1's anti-inference rule). Same failure mode as the 08-14..08-19 gap recovered on 08-19; root cause of the append-step failure itself is still undiagnosed and remains a standing candidate for a future `automation`/`meta` scan surface. Separately, and NOT the same failure mode: 2026-08-20 through 2026-08-23 have no `dream/*` branches, issues, or PRs at all — the pipeline did not run those 4 nights. Backfilled below from the PRs directly.

| 2026-08-24 | swarm | weightedConsensus() trust weights now reach the vote tally — gossip weighted-minority flip verified | #3085 | #3086 | yes | ACCEPT | gossip weighted flip: baseline approved=false (flat 0.50) → candidate approved=true (approvalRate≈0.905); 226/226 tests | 08d44c58... | recovered-live (9-night gap, ledger-append bug) |
| 2026-08-25 | performance | wire productQuantizeDistance() into HNSW search path, fixing near-chance PQ recall | #3093 | #3094 | yes | ACCEPT | recall@10 product-quantized 0.097→0.270 (unquantized baseline 1.000); 461/462 tests | 300da158... | 08-24 (#3086) still open/draft |
| 2026-08-26 | security | bind ADR-377 caller-identity verification into live authorizeMcpTool chokepoint | #3102 | #3103 | yes | ACCEPT-with-caveats | 6/6 new auth scenarios (reject unsigned/forged/expired, accept legitimate) pass; 583/583 security, 241/241 codex tests | fd944eaa... | 08-25 (#3094) still open/draft |
| 2026-08-27 | intelligence | wire computeConfidencePenalty/updateFisherFromConfidences into distillLearning's EWC gate | #3109 | #3110 | yes | ACCEPT-scoped (corrected post-review) | Fisher dims consulted per penalty 1/384→384/384 averaged; 152/152 tests (+4 new) | 89946458... | 08-26 (#3103) still open/draft |
| 2026-08-28 | memory | wire HybridBackend's dead weights field into weighted-RRF fusion | #3118 | #3119 | yes | ACCEPT | structured-weight-dominant fusion test fails on baseline, passes on candidate; 461/462 tests | 47e2f669... | 08-27 (#3110) still open/draft |
| 2026-08-29 | swarm | fix TopologyManager.rebalanceHybrid() one-directional adjacency | #3122 | #3123 | yes | ACCEPT | asymmetric edge agent-6→agent-2 pre-fix, symmetric post-fix; 221/221 tests | 9c1e9cd4... | 08-28 (#3119) still open/draft |
| 2026-08-30 | performance | remove unwired diskann-backend.ts (375 lines, 0 call sites), fix stale HNSW claims in generated CLAUDE.md | #3129 | #3130 | yes | ACCEPT | stale "150x-12,500x" claim replaced with measured "~1.9x-4.7x"; 17/17 generateClaudeMd tests | 3c98578c... | 08-29 (#3123) still open/draft |
| 2026-08-31 | security | opt-in MCP governance policy enforcement (audit log + maxToolCallsPerTurn) at tools/call dispatch | #3138 | #3139 | yes | ACCEPT | 16/16 new policy-enforcer tests; 39/43 MCP suite (4 pre-existing unrelated failures); default-off path byte-identical | 670cbbad... | 08-30 (#3130) still open/draft |
| 2026-09-01 | security | sliding-window reset for maxToolCallsPerTurn (wall-clock turnWindowMs, was permanent lockout) | #3151 | #3152 | yes | ACCEPT | 31/31 policy-enforcer tests (24 pre-existing + 7 new); broader MCP sweep 52/56→201/204 after building two disclosed-unbuilt sibling packages | 7d93a482... | 08-31 (#3139) still open/draft; stacked on #3139, merge order matters |
| 2026-09-02 | intelligence | LearningBridge.consolidate() reward-blind fix (hardcoded 1.0 → real insight confidence via getByKey; round-1 fix had wrong id/key lookup, caught by adversarial critic, corrected round 2) | #3159 | (pending) | yes | ACCEPT | 56/56→62/62 tests (candidate), 464/465 full package (1 pre-existing environmental failure) | bead6402... | 08-24..09-01 (9 nights) recovered live this run; none merged yet |
