...
| 2026-09-02 | intelligence | LearningBridge.consolidate() reward-blind fix (hardcoded 1.0 → real insight confidence via getByKey; round-1 fix had wrong id/key lookup, caught by adversarial critic, corrected round 2) | #3159 | #3160 | yes | ACCEPT | 56/56→62/62 tests (candidate), 464/465 full package (1 pre-existing environmental failure) | bead6402... | 08-24..09-01 (9 nights) recovered live this run; none merged yet |
