...
| 2026-08-20..23 | — | pipeline did not run — no branch/PR/issue for any of these 4 dates (confirmed via `git ls-remote`/PR search by both 08-24 and 08-26 nights, not a ledger-append gap like 08-14..18) | — | — | n/a | n/a | n/a | n/a | undiagnosed 4-night gap, root cause not investigated |
| 2026-08-24 | swarm | QueenCoordinator.weightedConsensus() computed real trust weights, never reached raft/byzantine/gossip vote tally (flat count only) — threaded through with [0,1] clamp | #3085 | #3086 | yes | ACCEPT | 226/226 tests (223 pre-existing+16 new); gossip weighted-flip scenario: baseline approved=false → candidate approved=true | 08d44c58... | backfilled live tonight (08-26) — 08-16..19 all MERGED 2026-08-21; 08-14/15 REJECT-evidence correctly still open |
| 2026-08-25 | performance | HNSWIndex product-quantization: productQuantizeDistance() implemented+tested, never dispatched from distance()/distanceOptimized() — search ran meaningless generic distance on PQ centroid indices | #3093 | #3094 | yes | ACCEPT | recall@10 0.097→0.270 (product-quantized); 461/462 tests (1 pre-existing unrelated env failure) | 300da158... | backfilled live tonight (08-26) — 08-24 (#3086) still open awaiting review |
| 2026-08-26 | security | authorizeMcpTool() trusted unsigned CLAUDE_FLOW_PRINCIPAL_ID env var as caller identity (ASI07-class); bound already-built ADR-377 Ed25519 verifyInvocationToken into that live chokepoint for DualModeOrchestrator-spawned workers, off by default | #TBD | #TBD | yes | ACCEPT-with-caveats | 6/6 new scenarios pass post-fix, correctly fail/reject pre-fix; 583/583 security, 241/241 codex, 18/18 policy-runtime; 19 pre-existing CLI failures proven identical via stash-diff | TBD | 08-24 (#3086)/08-25 (#3094) both still open awaiting review; 08-20..23 gap re-confirmed, still undiagnosed |
