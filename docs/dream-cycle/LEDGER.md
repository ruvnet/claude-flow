...
| 2026-08-31 | security | MCP tools/call dispatch never read `.harness/mcp-policy.json`; opt-in PolicyEnforcer wires auditLog + maxToolCallsPerTurn into stdio dispatch | #3138 | #3139 | yes | ACCEPT | 16/16 new tests, 39/43 broader MCP sweep (4 pre-existing env failures, unrelated) | 670cbbad... | #3027 open/draft (as designed), #3034 closed unmerged (as designed), #3044/#3049/#3057/#3062 all MERGED 2026-08-21 |
| 2026-09-01 | security | maxToolCallsPerTurn was session-lifetime cumulative, never reset (disclosed bug in #3139); wall-clock sliding window fix, `turnWindowMs` policy field (follow-up to #3139, stacked PR) | #3151 | #3152 | yes | ACCEPT | 30/30 new-suite tests, 52/56 broader MCP sweep (4 pre-existing env failures, unrelated); independent critic CONFIRMED-WITH-CAVEATS, 2 minor findings fixed pre-commit | 7d93a482... | zero of last 14 dream-cycle PRs merged (#3026-#3139, all OPEN); real 4-night pipeline gap confirmed 2026-08-20..08-23 (no branch/issue, distinct from cosmetic ledger staleness) |
